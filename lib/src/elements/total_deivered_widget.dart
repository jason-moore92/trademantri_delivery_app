...
class TotalDeliverdWidget extends StatefulWidget {
  @override
  _TotalDeliverdWidgetState createState() => _TotalDeliverdWidgetState();
}

class _TotalDeliverdWidgetState extends State<TotalDeliverdWidget> {
                  ...
                  children: [
                    ...
                    Text(
                      myDeliveryDashboardDataProvider.myDeliveryDashboardDataState.dashboardData!.isEmpty ||
                              myDeliveryDashboardDataProvider.myDeliveryDashboardDataState.dashboardData!["deliveredOrders"].isEmpty
                          ? "0"
                          : "${myDeliveryDashboardDataProvider.myDeliveryDashboardDataState.dashboardData!["deliveredOrders"][0]["totalCount"]}",
                      style: TextStyle(fontSize: fontSp * 20, color: Colors.black, fontWeight: FontWeight.bold),
                    ),
                  ],
                ),
